...
public class BookBean {
	...
	public static int dataPerPage = 10; //한 페이지에 보일 게시물 수(10개)
	public static int totalPage = 1;	//총 페이지 수 (총 데이터 수 / dataPerPage)
	public static int currentPage = 1;	//현재 페이지 
	
	//리스트 하단에 보여질 페이지 이동 만들기
	//block : 하단에 보여질 페이지 갯수 (ex.block = 5)
	public static String pageNumber(int block) {
		String str=""; //하단에 보여질 페이지 이동
