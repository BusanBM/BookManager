...
<section>
	<br>	
	<form name="f1" action="c_contentOk_alt.jsp">
		<div align="center">
			<h2>고객 정보 수정</h2>
		</div>
		<table border="1" align="center" width="350" heignt="100">
			...
			<tr>
		        ...
		        <td><input type="hidden" name="cs_no"><%=rs.getString("cs_no")%></td>
		    </tr>
			<tr>
			...
			<tr>	            
	            ...
	            <td><input type="hidden" name="cs_grade" ><%=rs.getString("cs_grade")%></td>
		    </tr>	            
	            
			<tr>	            
	            <td align="center">포인트</td>
	            <td><input type="hidden" name="cs_point" ><%=Integer.parseInt(rs.getString("cs_point"))%></td>
			</tr>
	...
	<hr width=80% />
	<div align=center>
 		[<a	href='c_delete.jsp?cs_no=<%=rs.getString("cs_no")%>'>회원탈퇴</a>]
